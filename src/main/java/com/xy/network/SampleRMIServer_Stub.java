...
public final class SampleRMIServer_Stub
    extends java.rmi.server.RemoteStub
    implements SampleRMI, java.rmi.Remote
{
    ...
    // Constructors
    public SampleRMIServer_Stub() {
        super();
    }
    public SampleRMIServer_Stub(java.rmi.server.RemoteRef rep) {
        super(rep);
    }
    // Methods from remote interfaces
    
    // Implementation of justPass
    public java.lang.String justPass(java.lang.String $_String_1) throws java.rmi.RemoteException {
        int opnum = 0;
